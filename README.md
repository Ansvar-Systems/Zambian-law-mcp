...
**The Zambia Law alternative for the AI age.**

[![npm version](https://badge.fury.io/js/%40ansvar/zambia-law-mcp.svg)](https://www.npmjs.com/package/@ansvar/zambia-law-mcp)
[![MCP Registry](https://img.shields.io/badge/MCP-Registry-blue)](https://registry.modelcontextprotocol.io)
[![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![GitHub stars](https://img.shields.io/github/stars/Ansvar-Systems/Zambia-law-mcp?style=social)](https://github.com/Ansvar-Systems/Zambia-law-mcp)
[![CI](https://github.com/Ansvar-Systems/Zambia-law-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/Ansvar-Systems/Zambia-law-mcp/actions/workflows/ci.yml)
...
Query **494 Zambian Acts** -- from the Data Protection Act and Computer Misuse and Cybercrimes Act to the Companies Act, Constitution of Zambia, and more -- directly from Claude, Cursor, or any MCP-compatible client.
...
Zambian legal research is scattered across Zambia Law Reports, the Zambia Gazette, and various government portals. Whether you're:
- A **lawyer** validating citations in a brief or contract under Zambian law
- A **compliance officer** checking if the Data Protection Act 2019 provisions apply to your processing activities
- A **legal tech developer** building tools on Zambian legislation
...
**Endpoint:** `https://zambia-law-mcp.vercel.app/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add zambia-law --transport http https://zambia-law-mcp.vercel.app/mcp` |
...
```json
{
  "mcpServers": {
    "zambia-law": {
      "type": "url",
      "url": "https://zambia-law-mcp.vercel.app/mcp"
    }
  }
}
```
...
- *"What does the Constitution of Zambia say about the right to privacy?"*
- *"Search for data breach notification requirements in Zambian law"*
- *"What are the obligations under the National Payment Systems Act?"*
- *"Validate this legal citation"*
- *"Build a legal stance on personal data processing in Zambia"*
...
| **Zambia Information and Communications Act** | 1998 (amended) | Regulates telecommunications and ICT sector; establishes the Communications Authority of Zambia |
...
| **Constitution of Zambia** | 2010 | Supreme law; Article 31 guarantees the right to privacy |
...
**Estimated database size:** ~80-150 MB (full corpus of Zambian federal legislation)
...
| `format_citation` | Format citations per Zambian conventions (full/short/pinpoint) |
...
| Tool | Description |
|------|-------------|
| `get_eu_basis` | Get EU directives/regulations for Zambian statute |
| `get_zambian_implementations` | Find Zambian laws implementing EU act |
| `search_eu_implementations` | Search EU documents with Zambian implementation counts |
...
- All statute text is ingested from official Zambian government sources
...
- **[Zambia Law Reports](https://zambialaw.org)** -- Official Zambian government legal database
...
>
> Statute text is sourced from official Zambian government publications. However:
...
```bash
git clone https://github.com/Ansvar-Systems/Zambia-law-mcp
cd Zambia-law-mcp
npm install
npm run build
npm test
...
**30+ national law MCPs** covering Australia, Brazil, Canada, China, Denmark, Finland, France, Germany, Ghana, Iceland, India, Ireland, Israel, Italy, Japan, Zambia, Netherlands, Nigeria, Norway, Singapore, Slovenia, South Korea, Sweden, Switzerland, Thailand, UAE, UK, and more.
...
```bibtex
@software{zambia_law_mcp_2025,
  author = {Ansvar Systems AB},
  title = {Zambian Law MCP Server: AI-Powered Legal Research Tool},
  year = {2025},
  url = {https://github.com/Ansvar-Systems/Zambia-law-mcp},
  note = {Zambian legal database with full-text search and EU cross-references}
}
```
...
- **Statutes & Legislation:** Zambian Government (public domain)
