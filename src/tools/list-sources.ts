  ...
  return {
    results: {
      sources: [
        {
          name: 'Zambia Law',
          authority: 'National Council for Law Reporting (Zambia Law)',
          url: 'http://zambialii.org',
          license: 'Government Open Data',
          coverage:
            'All Acts of Parliament (revised edition), subsidiary legislation, ' +
            'the Constitution of Zambia (2010), Zambia Gazette notices, and selected case law ' +
